...
pnpm test:smoke           # bundled-output smoke; PGlite flavor by default (self-builds .output-smoke)
pnpm test:smoke:postgres  # same suite against real Postgres (needs pnpm build + compose.dev.yaml)
